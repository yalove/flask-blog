...
from ..forms.topics import TopicForm
from ..forms.comments import Comment_Form,Comment_User_Form
...
def topic_single(topic_name):
    ...
    return render_template("topic_single.html",topic=topic,current_user=current_user,user=user,comments = comments,comment_form=comment_form)